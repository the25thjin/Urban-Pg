    ...
    return(
        ...
        <div>
            <div className="h-screen bg-cover bg-no-repeat bg-center grid place-items-center" style={{backgroundImage: `url(${hero})`}}>
                ...
                <button className="bg-orange-700 text-white  h-10 w-40 rounded-xl mt-10 transition duration-300 ease-in-out shadow-2xl shadow-orange-700 hover:bg-orange-900 hover:scale-110">Your Next Home</button>
