              ...
              <div className="w-[300px] sm:w-[400px] md:w-[300px] xl:w-[400px] h-[500px]  bg-white/15 backdrop-blur-sm border border-white/15  shadow-2xl text-center rounded-2xl">
                ...
                <div className="mt-4 ml-7">
                  ...
                  <div className="flex gap-4">
                    <div>
                    <svg className="mt-2" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" width="20" height="20" viewBox="0 0 2476 2476" id="instagram">
...
<svg className="w-[20px] h-[20px] mt-6 " xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 16 16" id="facebook">
  <path fill="#ffffff" fill-rule="evenodd" d="M12 5.5H9v-2a1 1 0 0 1 1-1h1V0H9a3 3 0 0 0-3 3v2.5H4V8h2v8h3V8h2l1-2.5z" clip-rule="evenodd"></path>
</svg>
                    </div>
                    <div className="flex mt-2 text-sm justify-between flex-col"> 
                      <h1>_mann.15_</h1>
                      <h1 className="text-left">Mann</h1>
                    </div>
                  </div>
                </div>
                <div className="mt-6">
                <textarea readOnly maxLength={50}  value={"Hey my name is Mann"} className="text-black shadow-xl border  text-sm resize-none w-[250px] sm:w-[350px] md:w-[250px] xl:w-[350px] h-[100px] rounded-md bg-white/45 text-left p-2 outline-none"/>
                </div>
                <div className=" absolute right-6 bottom-6">
                  <button className="bg-white/45 text-sm duration-200 transition ease-in-out hover:scale-110 border cursor-pointer shadow-lg p-2 w-[110px]  rounded-3xl">Edit Profile</button>
                </div>
              </div>
