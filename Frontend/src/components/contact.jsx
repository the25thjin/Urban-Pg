...
function Contact(){
    ...
    <div className="text-[#d4d4d4] font-Poppins mb-16">
        ...
        <div className="flex justify-around items-center mt-20 ">
            <div className="h-[420px] w-[400px] bg-[#793406] flex-col  p-6 rounded-3xl">
                <div>
                ...
                <div className="mt-7 mb-4">
                    <h1>Your Message</h1>
                    <textarea className="  bg-[#0e0901bd] mt-2 w-[350px] h-[90px] rounded p-1 outline-none"  placeholder="Message"/>
                </div>
                <div>
