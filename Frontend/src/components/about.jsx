        ...
        <div>
            ...
            <div className="font-Poppins flex-col flex-wrap h-[1400px]">
                ...
                <div className=" text-white h-[535px] w-[532px] relative z-[-1] left-24 top-[-200px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    ...
                    <p className="text-lg p-2 text-center text-wrap">We're a team dedicated to helping students find the  best hostels, PGs, and flats near their colleges. With firsthand experience in student housing, we understand the challenges and are here to provide solutions.</p>
                </div>
                <div className=" text-white h-[535px] w-[532px] relative z-[-1] left-[55%] top-[-500px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    ...
                    <p className="text-lg p-2 text-center text-wrap">At Urban PG, we make finding student accommodations easy, affordable, and hassle-free. Our mission is to connect students with the perfect living spaces that fit their needs and budgets.</p>
                </div>
                <div className=" text-white h-[535px] w-[532px] relative z-[-1] left-24 top-[-600px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    ...
                    <p className="text-lg p-2 text-center text-wrap">We provide a comprehensive platform with a vast database of accommodations. From cozy hostels to spacious flats, our curated listings offer a variety of options to suit every preference and budget.</p>
                </div>
                <div className=" text-white h-[535px] w-[532px] relative z-[-1] left-[55%] top-[-900px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    ...
                    <p className="text-lg p-2 text-center text-wrap">We are committed to transparency and quality. Our platform features only verified listings with detailed descriptions, high-quality photos, and genuine reviews from other students.</p>      
                </div>     
            </div>
