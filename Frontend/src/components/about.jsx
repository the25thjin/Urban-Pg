...
function About(){
    return(
        ...
        <div>
            <div>
                <h1 className="text-[#d4d4d4] text-center font-Poppins sm:text-left font-extrabold text-[40px] sm:text-[50px] m-10 sm:m-28 relative z-[-1] sm:top-14 sm:left-[57%]">About Us</h1>
            </div>  
            <div className="font-Poppins flex flex-col justify-center items-center sm:justify-start sm:items-start w-screen h-[1400px] ">
        
                <div className=" text-white h-[353px] w-[312px] sm:h-[535px] sm:w-[532px] relative z-[-1] sm:left-24   sm:top-[-200px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image1}/>
                 ...
                 <div className=" text-white h-[353px] w-[312px]  sm:h-[535px]  sm:w-[532px] relative z-[-1] sm:left-[55%]  top-10   sm:top-[-500px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image2}/>
                ...
                <div className=" text-white h-[353px] w-[312px]  sm:h-[535px] sm:w-[532px] relative z-[-1] sm:left-24  sm:top-[-600px] top-20 rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image3}/>
                    ...
                    <div className=" text-white h-[353px] w-[312px]  sm:h-[535px] sm:w-[532px] relative z-[-1] sm:left-[55%]  top-28 sm:top-[-900px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image4}/>
