    ...
    return(
        ...
        <div>
           ...
           <div className="font-Poppins  flex flex-col justify-center items-center xl:justify-start xl:items-start w-screen xl:h-[1400px] ">
                ...
                <div className=" text-white h-[353px] w-[312px] sm:h-[535px] sm:w-[532px] relative z-[-1] xl:left-24 xl:top-[-200px]  rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image1}/>
                 ...
                 <div className=" text-white h-[353px] w-[312px]  sm:h-[535px]  sm:w-[532px] relative z-[-1] xl:left-[55%]  top-10   xl:top-[-500px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image2}/>
                ...
                <div className=" text-white h-[353px] w-[312px]  sm:h-[535px] sm:w-[532px] relative z-[-1] xl:left-24  xl:top-[-600px] top-20 rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image3}/>
                    ...
                    <div className=" text-white h-[353px] w-[312px]  sm:h-[535px] sm:w-[532px] relative z-[-1] xl:left-[55%]  top-28 xl:top-[-900px] rounded-3xl bg-[#653E3E] bg-opacity-45 ">
                    <img  src={image4}/>
